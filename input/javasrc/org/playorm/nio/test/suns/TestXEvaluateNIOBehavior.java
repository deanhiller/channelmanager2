...
//	private boolean isWindows;
	...
	//		SelectionKey key = 
			...
			try {
				...
				fail("Looks like they fixed a socket not being closed until the selectNow or select is called");
			} catch(ExpectFailedException e) {
				assertEquals("Should have been a timeout failure", ExpectFailedException.TIMED_OUT, e.getReason());
			}
		}
	}	
}
