...
//	private static final int NUM_BYTES_IN_CHAR = Character.SIZE/8;
	 ...
	 * and Writers have.
	 * 
	 * @see biz.xsoftware.api.nio.BufferHelper#putString(java.nio.ByteBuffer, java.lang.String)
	 */
	...
	/**
	 * @see biz.xsoftware.api.nio.BufferHelper#doneFillingBuffer(java.nio.ByteBuffer)
	 */
...
//		log.info("buffer='"+s+"'");
	...
	/**
	 * @see biz.xsoftware.api.nio.BufferHelper#eraseBuffer(java.nio.ByteBuffer)
	 */
	...
	/**
	 * @see biz.xsoftware.api.nio.BufferHelper#processForPacket(java.nio.ByteBuffer, java.nio.ByteBuffer)
	 */
